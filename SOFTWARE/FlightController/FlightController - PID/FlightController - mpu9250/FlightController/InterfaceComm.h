...
bool ReceiveInterfaceData(){
	...
	if (inChar == END_MSG){
		...
		if(parameter.equals(YAW_KP)){
			ID = ReceiveID::KP_YAW;
			DataReceived[ReceiveID::KP_YAW] = value;
		}else if(parameter.equals(YAW_KI)){
			ID = ReceiveID::KI_YAW;
			DataReceived[ReceiveID::KI_YAW] = value;
		}else if(parameter.equals(YAW_KD)){
			ID = ReceiveID::KD_YAW;
			DataReceived[ReceiveID::KD_YAW] = value;
		}else if(parameter.equals(PITCH_KP)){
			ID = ReceiveID::KP_PITCH;
			DataReceived[ReceiveID::KP_PITCH] = value;
		}else if(parameter.equals(PITCH_KI)){
			ID = ReceiveID::KI_PITCH;
			DataReceived[ReceiveID::KI_PITCH] = value;
		}else if(parameter.equals(PITCH_KD)){
			ID = ReceiveID::KD_PITCH;
			DataReceived[ReceiveID::KD_PITCH] = value;
		}else if(parameter.equals(ROLL_KP)){
			ID = ReceiveID::KP_ROLL;
			DataReceived[ReceiveID::KP_ROLL] = value;
		}else if(parameter.equals(ROLL_KI)){
			ID = ReceiveID::KI_ROLL;
			DataReceived[ReceiveID::KI_ROLL] = value;
		}else if(parameter.equals(ROLL_KD)){
			ID = ReceiveID::KD_ROLL;
			DataReceived[ReceiveID::KD_ROLL] = value;
		}
